#pyinstaller C:\SPS_python\.venv\Marshall\_dod.py --onefile
import os
import openpyxl
...
def create_table(document, rows, table_title, effort_type):
    ...
    for row in rows:
        ...
        #takes the input from the user and outputs the effort as either percent or decimal formatting.
        if effort_type == 'p':
...
# Create a table for projects if there is any for that Category type
